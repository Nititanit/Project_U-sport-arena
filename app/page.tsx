        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-2">
              <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-medium">15 Sep</span>
              <span className="bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium">All</span>
              <span className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm font-medium hover:bg-gray-300 cursor-pointer">Football</span>
              <span className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm font-medium hover:bg-gray-300 cursor-pointer">Fitness</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link href="/fields/1">
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Stadium 1 (VIP)</h3>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-semibold">4.6 (1)</span>
            ...
            <Link href="/fields/2">
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Stadium 2 (VIP)</h3>
                  <p className="text-sm text-gray-600 mb-3 flex items-center gap-1">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-semibold">4.5 (12)</span>
                    <span className="text-sm text-gray-600">Football</span>
                  </div>
            ...
            <Link href="/fields/3">
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Stadium 3</h3>
                  <p className="text-sm text-gray-600 mb-3 flex items-center gap-1">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-semibold">4.8 (20)</span>
                    <span className="text-sm text-gray-600">Football</span>
                  </div>
            ...
            <Link href="/fields/4">
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Stadium 4</h3>
                  <p className="text-sm text-gray-600 mb-3 flex items-center gap-1">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-semibold">4.3 (30)</span>
                    <span className="text-sm text-gray-600">Football</span>
                  </div>
            ...
            <Link href="/fields/5">
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <div className="p-4">
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Fitness U Sport</h3>
                  <p className="text-sm text-gray-600 mb-3 flex items-center gap-1">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-semibold">4.2 (8)</span>
